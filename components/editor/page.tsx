    ...
    >
      <TooltipProvider>
        <Tooltip>
          ...
          <TooltipContent>
            <p className="text-xs">
              {sidePanelCollapsed ? "Mở rộng thanh bên" : "Thu gọn thanh bên"}
            </p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
      ...
      <TooltipProvider>
        <Tooltip>
          ...
          <TooltipContent>
            <p className="text-xs">
              {editPanelCollapsed ? "Mở rộng bảng chỉnh sửa" : "Thu gọn bảng chỉnh sửa"}
            </p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
      ...
      <TooltipProvider>
        <Tooltip>
          ...
          <TooltipContent>
            <p className="text-xs">
              {previewPanelCollapsed ? "Mở rộng bảng xem trước" : "Thu gọn bảng xem trước"}
            </p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Kích thước thanh bên
    newSizes.push(sidePanelCollapsed ? 0 : 20);

    // Kích thước khu vực chỉnh sửa
