...
// Mapping các field sang tiếng Việt
        ...
        >
          {useIconMode ? (
            ...
            <div className="flex items-center gap-2 overflow-hidden">
              {!item.custom && (
                <span>{FIELD_LABELS[item.key] || item.key}:</span>
              )}
