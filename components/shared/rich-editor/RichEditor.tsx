...
const getColors = (): ColorOption[] => [
  { label: "Đen", value: "#000000" },
  { label: "Xám đậm", value: "#333333" },
  { label: "Xám", value: "#666666" },
  { label: "Đỏ", value: "#FF0000" },
  { label: "Cam", value: "#FF4D00" },
  { label: "Cam vàng", value: "#FF9900" },
  { label: "Vàng", value: "#FFCC00" },
  { label: "Vàng xanh", value: "#33CC00" },
  { label: "Xanh lá", value: "#00CC00" },
  { label: "Xanh lam nhạt", value: "#00CCCC" },
  { label: "Xanh dương nhạt", value: "#0066FF" },
  { label: "Xanh dương", value: "#0000FF" },
  { label: "Tím", value: "#6600FF" },
  { label: "Hồng đậm", value: "#CC00FF" },
  { label: "Hồng", value: "#FF00FF" },
];
  ...
  return (
    <div className="relative" onClick={(e) => e.stopPropagation()}>
      <Button
        ...
        size="sm"
        className={cn(
          "h-8 w-8 rounded-md transition-all duration-200 hover:scale-105 p-0",
          isActive
      ...
      {tooltip && showTooltip && (
        <div
          className={cn(
            ...
            "bg-deep-blue-dark text-white border border-white/20"
          )}
        >
          {tooltip}
        </div>
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="h-8 w-8 p-0 rounded-md hover:scale-105 transition-all duration-200 text-white/80 hover:bg-white/10 hover:text-white relative group"
        >
          <PaintBucket
            className="h-4 w-4"
            style={{
      ...
      <PopoverContent className="w-64 p-3 rounded-lg">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium">Màu chữ</span>
          </div>
...
const BackgroundColorButton = ({ editor }: { editor: Editor | null }) => {
  ...
  useEffect(() => {
    // Thuộc tính highlight có thể trả về giá trị màu trực tiếp
    const highlight =
    ...
    <Popover>
      <PopoverTrigger asChild>
        ...
        >
          ...
          <span className="sr-only">Màu nền</span>
        </Button>
      </PopoverTrigger>
      <PopoverContent className="w-64 p-3 rounded-lg">
        <div className="flex flex-col gap-2">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={cn("h-4 w-px", "bg-white/30")} />
            ...
            <Button
              ...
              onClick={() => {
                toast.info("Tính năng đang được phát triển", {
                  description: "AI làm đẹp sẽ sớm được ra mắt!",
                });
              }}
              className="h-7 px-2 text-xs bg-gradient-to-r from-orange to-orange-dark hover:from-orange-dark hover:to-orange text-white border-none shadow-md transition-all duration-300"
            >
